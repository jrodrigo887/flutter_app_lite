...
class CaptureEntryConfigurationModel extends Equatable {
  ...
  const CaptureEntryConfigurationModel({
  ...
  factory CaptureEntryConfigurationModel.fromMap(Map<String, dynamic> data) {
    return CaptureEntryConfigurationModel(
      ...
      fields: (data['Fields'] as List<dynamic>?)
          ?.map((e) => FieldModel.fromMap(e as Map<String, dynamic>))
          .toList(),
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [CaptureEntryConfigurationModel].
  factory CaptureEntryConfigurationModel.fromJson(String data) {
    return CaptureEntryConfigurationModel.fromMap(
        json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [CaptureEntryConfigurationModel] to a JSON string.
  String toJson() => json.encode(toMap());

  CaptureEntryConfigurationModel copyWith({
